            ...
            <div class="brand-logo">
                <a href="index.html">
                    ...
                    <span class="brand-title">
                        <img src="../resource/image/logo-text.png" alt="">
                    </span>
                </a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">월별메출</h3>
                                ...
                                <div class="active-member">
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="../resource/image/avatar/1.jpg" class=" rounded-circle mr-3" alt="">Sarah Smith</td>
                                                    <td>iPhone X</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="../resource/image/avatar/2.jpg" class=" rounded-circle mr-3" alt="">Walter R.</td>
                                                    <td>Pixel 2</td>
                                                ...
                                                <tr>
                                                    <td><img src="../resource/image/avatar/3.jpg" class=" rounded-circle mr-3" alt="">Andrew D.</td>
                                                    <td>OnePlus</td>
                                                ...
                                                <tr>
                                                    <td><img src="../resource/image/avatar/6.jpg" class=" rounded-circle mr-3" alt=""> Megan S.</td>
                                                    <td>Galaxy</td>
                                                ...
                                                <tr>
                                                    <td><img src="../resource/image/avatar/4.jpg" class=" rounded-circle mr-3" alt=""> Doris R.</td>
                                                    <td>Moto Z2</td>
                                                ...
                                                <tr>
                                                    <td><img src="../resource/image/avatar/5.jpg" class=" rounded-circle mr-3" alt="">Elizabeth W.</td>
                                                    <td>Notebook Asus</td>
